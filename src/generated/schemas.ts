...
export const InitiateImageUploadResponseSchema = z.object({image_url: z.string()}).strict();
export type InitiateImageUploadResponse = zInfer<typeof InitiateImageUploadResponseSchema>;

// OPEN_SHARE_MOMENT_DIALOG
export const OpenShareMomentDialogRequestSchema = z.object({mediaUrl: z.string().max(1024)}).strict();
export type OpenShareMomentDialogRequest = zInfer<typeof OpenShareMomentDialogRequestSchema>;

// AUTHENTICATE
export const AuthenticateRequestSchema = z.object({access_token: z.union([z.string(), z.null()]).optional()}).strict();
      ...
      z
        .object({
          ...
          avatar_decoration_data: z
            .union([z.object({asset: z.string(), skuId: z.string().optional()}).strict(), z.null()])
            .optional(),
