...
See instructions on getting the oauth2 token and the bot token [here](https://discord.com/developers/docs/activities/building-an-activity#find-your-oauth2-credentials).
