...
See instructions on getting the oauth2 token and the bot token [here](https://discord.com/developers/docs/embedded-apps/getting-started#find-your-oauth2-credentials).
