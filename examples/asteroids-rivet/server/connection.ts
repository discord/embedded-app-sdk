...
import { Init, Input, Respawn, ServerSideSocket, Shoot } from "../shared/socket";
...
export function createConnection(socket: ServerSideSocket, game: GameState, takenNames: Set<string>): Connection {
	...
	const lifetimeData: LifetimeData = {
		...
		playerId: nanoid(16),
		playerName: username && typeof username == "string" ? username.trim() : sequentialNumberName(takenNames),
