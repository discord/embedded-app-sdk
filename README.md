...
Visit [our documentation site](https://discord.com/developers/docs/foo) for a complete example application. See more info on environment variables (`YOUR_OAUTH2_CLIENT_ID`, etc...) [here](https://discord.com/developers/docs/bar).
